function gameover(lastint) {
    $.ajax({
        ...
        success: function (result) {
            let balance = parseFloat(result).toFixed(2).replace('.', ',');
            $("#wallet_balance").text(currency_symbol + " " + balance);
            $("#header_wallet_balance").text(currency_symbol + " " + balance); // Show Header Wallet Balance
