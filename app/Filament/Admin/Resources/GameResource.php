                    ...
                    ->schema([
                        Forms\Components\Group::make()
                            ->schema([
                                ...
                                Forms\Components\FileUpload::make('home_cover')
                                    ->label('Capa para Página Inicial')
                                    ->placeholder('Carregue uma capa específica para a página inicial (opcional)')
                                    ->image()
                                    ->disk('public')
                                    ->directory('games/home-covers')
                                    ->dehydrated(fn ($state) => filled($state))
                                    ->columnSpanFull()
                                    ->helperText('Se não for definida, a capa padrão será usada na página inicial.'),
                            ]),
                        Forms\Components\Group::make()
                            ->schema([
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\ToggleColumn::make('is_featured')
                    ->label('Destaques'),
                Tables\Columns\ToggleColumn::make('is_slot')
                    ->label('Slots'),
