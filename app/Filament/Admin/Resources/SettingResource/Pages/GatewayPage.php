                ...
                Section::make('Gateways')
                    ...
                    ->schema([
                        ...
                        Select::make('mbway_gateway')
                            ...
                            ->default('eupago')
                            ->required()
                            ->helperText('Selecione qual gateway será utilizado para processar pagamentos via MBWay'),

                        Select::make('multibanco_gateway')
                            ...
                            ->default('eupago')
                            ->required()
                            ->helperText('Selecione qual gateway será utilizado para processar pagamentos via Multibanco'),
                        ...
                        Toggle::make('mbway_is_enable')
                            ->label('MBWay'),

                        Toggle::make('multibanco_is_enable')
                            ->label('MultiBanco'),

                        Toggle::make('mollie_is_enable')
                            ->label('Mollie'),
