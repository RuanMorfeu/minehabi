        ...
        return $form
            ->schema([
                ...
                Section::make('Suporte')
                    ->description('Configurações do suporte')
                    ->collapsible()
                    ->collapsed(true)
                    ->schema([
                        TextInput::make('link_suporte')
                            ...
                            ->url(),
                        Toggle::make('support_active')
                            ->label('Ativar suporte')
                            ->helperText('Ative ou desative o chat de suporte no site')
                            ->default(true)
                            ->onIcon('heroicon-o-check')
                            ->offIcon('heroicon-o-x-mark'),
                    ])->columns(2),

                Section::make('Gerenciamento de Cache')
                    ->description('Limpe o cache do sistema para aplicar alterações')
                    ->schema([
                                ...
                                '<div style="font-weight: 600; display: flex; align-items: center;">
                                    ...
                                    <a href="'.route('clear.cache').'" class="dark:text-white" 
                                       style="
                                            ...
                                            margin-left: 10px;
                                        " 
                                       onclick="return confirm(\'Tem certeza de que deseja limpar o cache? Isso afetará todos os usuários.\');">
                                        LIMPAR CACHE
                                    </a>
                                </div>'
                            )),
