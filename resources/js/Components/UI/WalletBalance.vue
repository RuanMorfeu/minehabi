<template>
    <button v-if="wallet?.total_balance === undefined || isLoadingWallet" disabled type="button" class="flex justify-center items-center mr-3 px-3 py-2 bg-gray-100 text-gray-500 rounded">
        <svg aria-hidden="true" role="status" class="inline w-4 h-4 mr-3 text-gray-400 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <button @click="$router.push('/profile/wallet')" v-else type="button" class="flex justify-center items-center mr-3 px-3 py-2 bg-blue-50 text-blue-700 rounded hover:bg-blue-100 transition-colors font-bold">
