  ...
  <div v-if="isVisible" class="popup-overlay" @click.self="closePopup">
    <div class="popup-container">
      <div class="popup-content">
        <button @click="closePopup" type="button" class="close-button">
        ...
        <div class="popup-header">
          <div class="promo-image-container">
            <div class="promo-image">
              <img src="https://assets.dei.bet/Ganhe%20(1).svg" alt="Deposite para jogar" class="w-full h-auto">
            </div>
          </div>
        </div>
        ...
        <div class="popup-body">
          <h3 class="popup-title">
            Desbloqueie o acesso aos jogos de Habilidade!
          </h3>
...
const isVisible = computed(() => uiStore.showExclusiveGamePopup);
const game = computed(() => uiStore.exclusiveGame);

const closePopup = () => {
  uiStore.setExclusiveGamePopup(false);
};
