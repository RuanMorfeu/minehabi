            ...
            <div class="">
                <ul>
                    <li
                        ...
                        class="flex justify-between px-4 py-3 mb-3 bg-white cursor-pointer dark:bg-gray-900 hover:bg-blue-700/20"
                    >
                    ...
                    <li
                        ...
                        class="flex justify-between px-4 py-3 mb-2 bg-white cursor-pointer dark:bg-gray-900 hover:bg-blue-700/20"
                    >
                        <div>
                            <img
                    ...
                    <form action="" @submit.prevent="submitQRCode">
                        ...
                        <div class="mt-3">
                            ...
                            >
                                ...
                                <!--                                <div v-if="deposit.amount > 0" class="font-bold text-right text-blue-500 w-80">-->
