...
import PlayModal from "@/Pages/Web/Casino/PlayModal.vue";
import DemoPlayModal from "@/Pages/Web/Casino/DemoPlayModal.vue";
...
export const routes = [
    ...
    },
    {
        ...
        path: '/ref/:code',
        redirect: (to) => {
            // Redireciona para home adicionando o parâmetro code
            return { path: '/', query: { code: to.params.code } }
        }
    },
    {
        name: 'login',
    ...
    {
        name: 'playModal',
        path: '/modal/:slug?/:type?/:valor?',
        component: PlayModal
    },
    {
        name: 'playModal2',
        path: '/modal2/:slug?/:type?/:valor?',
        component: PlayModal
    },
    {
        name: 'demoPlayModal',
        path: '/demo-game/:type?/:valor?',
