<template>
    ...
    <div class="sm:ml-64 transition-all duration-300" :class="'mt-[89px]'">
    ...
    <!-- Pop-up de Autenticação e Notificações -->
    <AuthPopup />
        <ExclusiveGamePopup />
        <ProviderGamePopup />
    ...
    <div id="modalMissionEl" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-blue-700">
...
import ExclusiveGamePopup from "@/Components/Popup/ExclusiveGamePopup.vue";
import ProviderGamePopup from '@/Components/Popup/ProviderGamePopup.vue';
...
export default {
    ...
    mounted() {
        ...
        const optionsTab = {
            ...
            activeClasses: 'active-tab text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-400 border-blue-600 dark:border-blue-500',
